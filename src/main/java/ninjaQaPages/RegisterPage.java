...
public class RegisterPage {
	...
	private WebElement duplicateEmailAddressWarnig;
	...
	public String retrieveDuplicateEmalAddressWarning() {
		String duplicateEmailWarningText = duplicateEmailAddressWarnig.getText();
	...
	public AccountSuccessPage registerwithMandarotyFields(String firstNameText, String lastNameText, String emailText,
	...
	public boolean displayStatusOfWarningMessages(String expectedPrivacyPolicyWarning, String expectedFirstNameWarning,
		...
		boolean privacyPolocyWarningStatus = privacyPolicyWarning.getText().contains(expectedPrivacyPolicyWarning);

		boolean firstNameWarningStatus = firstNameWarning.getText().equals(expectedFirstNameWarning); // equal assert is
																										// used in
																										// register
		...
		return privacyPolocyWarningStatus && firstNameWarningStatus && lastNameWarningStatus && emailWarningStatus
